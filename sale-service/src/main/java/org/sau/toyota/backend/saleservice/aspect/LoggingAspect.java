package org.sau.toyota.backend.saleservice.aspect;
...
/** @author Ahmet Alıç
 * @since 28-06-2024
 * Aspect for logging execution of service methods in the sale service.
 */
@Aspect
@Component
@Log4j2
public class LoggingAspect {
     ...
     * org.sau.toyota.backend.saleservice.service.Concrete package.
     */
    @Pointcut("execution(* org.sau.toyota.backend.saleservice.service.Concrete.*.*(..))")
